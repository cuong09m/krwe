...
function content_init(){
    ...
    add_meta_box("content_slider", "WP Content Slideshow Options", "content_meta", "breaking_history", "normal", "high");
    add_meta_box("content_slider", "WP Content Slideshow Options", "content_meta", "daiy_history", "normal", "high");
...
function save_content(){
    ...
    return $post_id;
    global $post;
    if($post->post_type == "post" || $post->post_type == "page" || $post->post_type == "breaking_history"|| $post->post_type == "daily_history") {
