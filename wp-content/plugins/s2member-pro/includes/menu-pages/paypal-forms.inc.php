				...
				public function __construct ()
					{
						...
						echo '<li><code>rt="M"</code> Regular Term. Only valid w/ Membership Level Access' . ((is_multisite () && c_ws_plugin__s2member_utils_conds::is_multisite_farm () && !is_main_site ()) ? '' : ' and/or Independent Custom Capabilities') . '. Possible values: <code>D</code> = Days, <code>W</code> = Weeks, <code>M</code> = Months, <code>Y</code> = Years, <code>L</code> = Lifetime. — <strong>NOTICE (regarding Payflow®):</strong> Please be aware that <code>D</code> = Days is NOT possible under PayPal® Pro (Payflow® Edition). If you are operating a PayPal® Pro account, with the Payflow® Edition, please take note. Payflow® supports ONLY a specific set of recurring intervals. Pro Forms integrated with the Payflow® API, can be configured to charge: weekly, bi-weekly, monthly, quarterly, or yearly.</li>' . "\n";
