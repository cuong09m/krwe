...
<form id="s2member-pro-paypal-checkout-form" class="s2member-pro-paypal-form s2member-pro-paypal-checkout-form" method="post" action="%%action%%">
	...
	<div id="s2member-pro-paypal-checkout-form-submission-section" class="s2member-pro-paypal-form-section s2member-pro-paypal-checkout-form-section s2member-pro-paypal-form-submission-section s2member-pro-paypal-checkout-form-submission-section">
        ...
        <p style="font-size: 10px">You authorize Keesing’s Worldwide, LLC to charge you credit/debit card or PayPal account at the price above now and in time to renew your Keesing’s subscription, without interruption, before the start of each new annual term at the subscriber rate then in effect, unless you tell us to stop.  You may cancel at any time during your subscription by contacting customer service at customerservice@keesings.com or click here for other contact options and you will receive a full refund on all unused full months of service.  If your credit/debit card or PayPal account cannot be charged, we’ll bill you directly instead.</p>
