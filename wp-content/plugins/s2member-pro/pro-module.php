...
if(!defined("WS_PLUGIN__S2MEMBER_PRO_VERSION"))
	define("WS_PLUGIN__S2MEMBER_PRO_VERSION", "121213" /* !#distro-version#! */);
/**
...
if(!defined("WS_PLUGIN__S2MEMBER_PRO_MIN_WP_VERSION"))
	define("WS_PLUGIN__S2MEMBER_PRO_MIN_WP_VERSION", "3.2" /* !#wp-requires-at-least-version#! */);
/**
...
if(!defined("WS_PLUGIN__S2MEMBER_PRO_MIN_FRAMEWORK_VERSION"))
	define("WS_PLUGIN__S2MEMBER_PRO_MIN_FRAMEWORK_VERSION", "121213" /* !#distro-version#! */);
/*
...
*/
else if(is_admin()) /* Admin compatibility errors. */
	{
		...
		else if(!version_compare /* They need to upgrade s2Member Pro? */(WS_PLUGIN__S2MEMBER_PRO_VERSION, WS_PLUGIN__S2MEMBER_MIN_PRO_VERSION, ">=") && file_exists(dirname(__FILE__)."/includes/classes/upgrader.inc.php"))
			{
				include_once /* Include upgrader class. s2Member Pro autoload functionality will NOT be available in this scenario. Using ``include_once()``. */ dirname(__FILE__)."/includes/classes/upgrader.inc.php";
