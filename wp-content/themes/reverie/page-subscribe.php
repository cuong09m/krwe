...
<aside id="sidebar" class="four columns" role="complementary" style="background: url('<?php echo get_template_directory_uri(); ?>/images/subbg2.png') repeat-x;height: 850px;">
	...
	<div class="sidebar-box">
		<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="subyear" style="background: url('<?php echo get_template_directory_uri(); ?>/images/subbg3.png') no-repeat;padding-top: 27px;height: 100px;">
			<input type="hidden" name="cmd" value="_s-xclick">
			<input type="hidden" name="hosted_button_id" value="VTKD8W7Z3DEPE">
			<input type="radio" id="selectyear" name="options" onclick="unCheckRadio('selectmonth')"/> <span style="color:#FFF;font-size:21px;">Annual Subscription</span><br /><br />
			<p style="text-align: center;"><span style="font-weight:bold;font-size:18px;font-style: normal;">12 month for $197</span><br />
			<span>just $16.41/month, save more than 30%</span>
			</p>
		</form>
		
		
		<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="submonth" style="background: #939598;padding-top: 10px;height: 39px; width: 280px; margin-bottom: 60px;">
			<input type="hidden" name="cmd" value="_s-xclick">
			<input type="hidden" name="hosted_button_id" value="8PCXDKP7BZK88">
			<input type="radio" id="selectmonth" name="options" onclick="unCheckRadio('selectyear')"/> <span style="color:#FFF;font-size:21px;">Monthly Subscription</span><br /><br />
			<p style="text-align: center;"><span style="font-size:18px;font-style: normal;">Just <strong>$24.99</strong></span>
			</p>
		</form>
		
		<button onclick="processsubmit();" style="background: url('<?php echo get_template_directory_uri(); ?>/images/subbg4.png') no-repeat;height: 36px; width: 286px;border: none;color:#FFF; font-size:18px;padding-bottom: 5px;cursor: pointer;">Get Keesing's Now</button>
	</div>
</aside>
<!-- /#sidebar -->
